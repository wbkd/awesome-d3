...
- [d3plus](https://github.com/alexandersimoes/d3plus) - An extension to the D3 library that allows fast and easy creation of data visualizations
...
- [d3-composite-projections](https://github.com/rveciana/d3-composite-projections) - Set of projections for showing countries' distant lands together
...
- [d3-nelson-rules](https://github.com/53seven/d3-nelson-rules) - Utility to apply nelsons rules of process control to a set of data
